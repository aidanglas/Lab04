...
public class Course
{
    ...
    {
        return "Course{" + "name=" + name + ", genEd=" + genEd + ", description=" + description + ", creditsMinPerCourse=" + creditsMinPerCourse + ", creditsMaxPerCourse=" + creditsMaxPerCourse + ", creditsMaximum=" + creditsMaximum + ", preReq=" + preReq + '}';
    }
